...
## Description of scripts and notebooks
  ...
  **fourier-lattice.ctl, level-set-fourier-lattice.scm**: scripts that directly run MPB on the two-tone lattices. The actual dielectric function, in real space, is created by the function **level-set-eps**. This function evaluates a Fourier sum and, depending on whether this sum takes a value above/below *medianeps* assigns a value to the dielectric function of *epsout*/*epsin*, respectively. 
