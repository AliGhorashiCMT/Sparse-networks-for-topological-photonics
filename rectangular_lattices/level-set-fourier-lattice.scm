...
(define (level-set-eps r)
    ;(calc-fourier-sum-fast r)
    ;(calc-fourier-sum-fast (vector3 (vector3-y r) (vector3-x r))) 
     (max (calc-fourier-sum-fast (vector3 (vector3-y r) (vector3-x r))) 1) ; try to replace the places where it goes below vacuum 
)
